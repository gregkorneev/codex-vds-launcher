...
Developer beta / macOS-first. Current build: **Codex VDS Launcher Developer Beta 2**.
...
- First-launch onboarding and a reusable VDS connection guide.
...
Developer beta / сначала macOS. Текущая сборка: **Codex VDS Launcher Developer Beta 2**.
...
- Приветственный экран первого запуска и повторно доступная инструкция подключения к VDS.
